...
const Footer = () => {
    const quickLinks: LinkItem[] = [
        { text: 'Catalogue / Brochure', href: 'https://kmigroups.com/catalog', target: '_blank' },
        { text: 'All Products', href: 'https://kmigroups.com/products', target: '_blank' },
        { text: 'Blogs', href: 'https://kmigroups.com/blogs', target: '_blank' },
            ...
            <footer className="py-10 relative overflow-hidden">
                <div className="max-w-[1440px] mx-auto px-6 md:px-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
                        ...
                        <div className="lg:col-span-4 pl-7">
                            <a href="https://kmigroups.com/">
                                <img src="https://kmigroups.com/images/kmi-iso.png" alt="KMI Group Logo" className="w-40 mb-6" />
                            </a>

                            <p className="text-black text-base mb-4">
                                KMI Group is Pakistan's leading manufacturer of MDF boards, UV sheets,
                                laminates, and decorative surfaces. For over a decade, MDF has been empowering
                                furniture makers, architects, and interior designers with durable and innovative material.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:col-span-8 gap-8 lg:gap-12 lg:ml-10">
                            ...
                            <div>
                                <h3 className="font-bold text-l lg:text-xl text-black mb-5">Catalogue Quick Links</h3>
                            ...
                            <div className="col-span-2 md:col-span-1">
                                <h3 className="font-bold text-l lg:text-xl text-black mb-5">Social Media</h3>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-3 hover:opacity-70 transition group"
                                    >
                                        <div className="hover:scale-110 transition-transform">
                                            <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none">
                                                <circle cx="16" cy="16" r="15" stroke="black" strokeWidth="0.75"></circle>
                                        ...
                                        <span className="text-black text-lg font-medium">KMI Facebook</span>
                                    </a>
                                    ...
                                    >
                                        ...
                                        <span className="text-black text-lg font-medium">KMI Instagram</span>
                                    </a>
                                    ...
                                    >
                                        ...
                                        <span className="text-black text-lg font-medium">KMI Twitter</span>
                                    </a>
                                    ...
                                    >
                                        ...
                                        <span className="text-black text-lg font-medium">KMI Pinterest</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Copyright Section - Footer ke last mein add kiya */}
                    <div className="mt-10 pt- text-center">
                        <p className="text-sm text-black">
                            @ 2026 KMI Group ALL Rights reserved by RankSol
                        </p>
                    </div>
                </div>
            </footer>
